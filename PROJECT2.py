def Project2():
    ...
    while flag_me_awake:
        ...
        if cmd == CMD_QUIT:
            print(
                "You pass out on the floor and ignore all of your surroundings like the lazy person you are.")
        ...
        if room == ROOM_LIVING:
            if cmd == CMD_SOUTH:
                ...
                if stella_is_hungry == True:
                    ...
                    print(
                        "Stella is happy chewing the bone. You may enter your bedroom.")
                    room = ROOM_BED
                    continue
            elif cmd == CMD_TV:
                if flag_tv_on == True:
        ...
        if room == ROOM_KITCHEN:
            ...
            if cmd == CMD_GET and pantry_door_open == True:
                print(
                    "You grab the tastiest dog treat for Stella. She watches you with great interest from the living room.")
                has_bone = True
                room = ROOM_KITCHEN
                continue
        ...
        if room == ROOM_OFFICE:
            if cmd == CMD_OPEN and safe_open == False:
                ...
                if firstNumber != 21 or secondNumber != 64 or thirdNumber != 32:
                    ...
                    print(
                        "You hear a satisfying 'Ka-CHUNK' as the handle turns and the safe\ndoor swings invitingly open. ")
        ...
        if room == ROOM_BED:
            if cmd == CMD_SOUTH:
                ...
                print(
                    "You hear a faint noise coming from the living room, keeping you awake.")
                room = ROOM_BED
                return False
            elif pantry_door_open == True:
                print(
                    "You remember that your pantry door is open, thus your crippling anxiety keeps you awake.")
                room = ROOM_BED
                return False
            elif has_key == True:
                print(
                    "You realize that you still have the key from the safe on you, better put that back where it belongs!")
                room = ROOM_BED
                return False
            elif cmd == CMD_BED and not (flag_tv_on or pantry_door_open or has_key or pantry_unlocked):
